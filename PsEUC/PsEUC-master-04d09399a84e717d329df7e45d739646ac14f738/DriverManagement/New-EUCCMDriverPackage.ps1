...
$DPINST_PATH = '\\m562prd1\src$\CM_Managed\Tools'
#$DRIVERPACKAGEPATH = '\\m562prd1\src$\CM_Managed\Apps\DriverPacks'
$DRIVERPACKAGEPATH = 'C:\TEMP'

function New-EUCCMDriverPackage
{
    [CmdletBinding()]
    Param
    (
...
AppPublisher=Brisbane City Council
CreateAppDir=no
